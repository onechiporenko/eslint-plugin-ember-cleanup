...
var invalidTests = j
  ...
  .createCombos(["code"], [{IS_ARRAY: "typeOf"}, {IS_ARRAY: "Ember.typeOf"}, {IS_ARRAY: "Em.typeOf"}, {IS_ARRAY: "Ember['typeOf']"}, {IS_ARRAY: "Array.isArray"}, {IS_ARRAY: "Array['isArray']"}])
  .uniqueCombos()
  .useCombosAsTemplates()
...
var validTests = j
  ...
  .uniqueCombos()
  .useCombosAsTemplates()
  .createCombos(["code"], [{IS_ARRAY: "Ember.isArray"}, {IS_ARRAY: "Em.isArray"}, {IS_ARRAY: "Ember['isArray']"}])
  .uniqueCombos()
  .useCombosAsTemplates()
  .createCombos(["code"], [{MOD: ".call("}, {MOD: ".apply("}, {MOD: "("}])
  .uniqueCombos()
